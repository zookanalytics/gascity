...
type City struct {
	...
	// not yet inherited automatically.
...
type DoctorConfig struct {
	...
	// stays empty for TOML marshaling (mirrors DaemonConfig.MaxRestarts).
...
func (c DoctorConfig) PackScriptTimeout() time.Duration {
	if c.PackScriptTimeoutSecs != nil && *c.PackScriptTimeoutSecs > 0 {
...
// default_sling_formula, append_fragments, and env; the remaining fields are
